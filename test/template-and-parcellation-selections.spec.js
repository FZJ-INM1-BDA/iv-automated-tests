...
exports.selectTAndP = async function selectTAndP() {
    ...
    ////////////////// Big Brain //////////////////////
    it('Select BigBrain (Parcellation Auto "Grey/White matter")',
    ...
    it('Select BigBrain (Parcellation Cytoarchitectonic Maps)',
        checkRegionSelectionByTwoRegion.bind(
            this,
            buttonTextForParcellation = ' Cytoarchitectonic Maps ',
            area1Coordinates = [340, 180],
            area1Name = 'Area TE 1.0 (HESCHL) (interpolated)',
            area2Coordinates = [630, 60],
            area2Name = 'Area 6d1 (PreCG) (interpolated)',
    ...
    async function checkRegionSelectionByTwoRegion() {
